...
<head>
    ...
    <title>Bebidas - Las Ollitas</title>
    ...
    <style>
        ...
        .bebidas-card {
            background: #fff;
            border: 1px solid rgba(43,74,111,0.12);
            border-radius: 3px;
            overflow: hidden;
            height: 100%;
            display: flex;
        ...
        .bebidas-card:hover {
            ...
            box-shadow: 0 16px 40px rgba(43,74,111,0.15);
        }
        ...
        .bebidas-card:hover .bebida-img-wrapper img {
        ...
        .bebidas-img-overlay {
            ...
            right: 0;
            height: 60px;
            background: linear-gradient(to top, rgba(43,74,111,0.45), transparent);
        }
...
<body>
    ...
    <!-- GRID DE BEBIDAS -->
    <div class="container bebidas-grid">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="bebidas-card">
                    ...
                    <div class="bebidas-img-wrapper">
                        <img
                            src="../uploads/<?php echo $fila['imagen']; ?>"
                            alt="<?php echo $fila['nombre']; ?>"
                        >
                        <div class="bebidas-img-overlay"></div>
                    </div>

                    <div class="bebidas-body">
                        <h3 class="bebidas-nombre"><?php echo $fila['nombre']; ?></h3>
                        <p class="bebidas-descripcion"><?php echo $fila['descripcion']; ?></p>
                        <div class="bebidas-footer">
                            <p class="bebidas-precio mb-0">
                                <span>Bs.</span><?php echo $fila['precio']; ?>
                            </p>
                            <span class="bebidas-badge">Disponible</span>
                        </div>
                    </div>
