...
<head>
    ...
    <title>Platos Especiales - Las Ollitas</title>
    ...
    <style>
        ...
        /* Estrella de "especial" en la esquina */
        .especial-star {
            position: absolute;
            top: 12px;
            left: 12px;
        ...
        .especial-card:hover .especial-img-wrapper img {
            transform: scale(1.04);
        }

        .especial-img-overlay {
            position: absolute;
            bottom: 0;
            left: 0;
            right: 0;
            height: 60px;
            background: linear-gradient(to top, rgba(45,90,61,0.5), transparent);
        }
...
<body>
    ...
    <div class="page-header">
        <p class="page-eyebrow">Lo mejor de la casa</p>
        <h1 class="page-title">Platos Especiales</h1>
        <p class="page-subtitle">Selección exclusiva preparada con los mejores ingredientes</p>
    ...
    <!-- GRID -->
    <div class="container especiales-grid">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="especial-card">
                    ...
                    <span class="especial-star">⭐ Especial</span>

                    <div class="especial-img-wrapper">
                        <img
                            src="../uploads/<?php echo $fila['imagen']; ?>"
                            alt="<?php echo $fila['nombre']; ?>"
                        >
                        <div class="especial-img-overlay"></div>
                    </div>

                    <div class="especial-body">
                        <h3 class="especial-nombre"><?php echo $fila['nombre']; ?></h3>
                        <p class="especial-descripcion"><?php echo $fila['descripcion']; ?></p>
                        <div class="especial-footer">
                            <p class="especial-precio mb-0">
                                <span>Bs.</span><?php echo $fila['precio']; ?>
                            </p>
                            <span class="especial-badge">Disponible</span>
                        </div>
                    </div>
