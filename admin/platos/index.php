...
$sql = "SELECT platos.*, categorias.nombre AS categoria
FROM platos
INNER JOIN categorias
ON platos.categoria_id = categorias.id";
...
<head>
    ...
    <title>Platos - Admin Las Ollitas</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tabla-search:focus { border-color: var(--color-dorado); }
        ...
        .td-acciones { display: flex; gap: 0.5rem; }
        ...
        .btn-editar:hover { background: #FDE68A; color: #92400E; }
        ...
        .btn-eliminar:hover { background: #FECACA; color: #B91C1C; }
...
<body>
    ...
    <div class="main">
        ...
        <div class="topbar">
            <p class="topbar-breadcrumb">Admin / <span>Platos</span></p>
        ...
        <div class="content">
            ...
            <div class="page-head">
                <div>
                    <h1 class="page-head-title">Platos, Bebidas y Extras</h1>
                    <p class="page-head-sub">Gestiona todos los productos del menú</p>
                </div>
                <a href="crear.php" class="btn-nueva">+ Nuevo Producto</a>
            </div>

            <div class="tabla-card">
                <div class="tabla-header">
                    <span class="tabla-header-title">Listado de productos</span>
                ...
                <table id="tabla-platos">
                    ...
                    <tbody id="tabla-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="td-nombre"><?php echo $fila['nombre']; ?></p>
                                <p class="td-nombre-sub"><?php echo mb_strimwidth($fila['descripcion'], 0, 55, '...'); ?></p>
                            </td>

                            <td>
                                <span class="badge-cat"><?php echo $fila['categoria']; ?></span>
                            </td>
                        ...
                        <?php if($total === 0): ?>
                        <tr class="empty-row">
                            <td colspan="6">🍽️ No hay productos registrados aún.</td>
                        </tr>
                        <?php endif; ?>
    ...
    <script>
        ...
        document.getElementById('conteo').textContent = total + ' registros';

        function filtrarTabla() {
            const input = document.getElementById('buscador').value.toLowerCase();
            const filas = document.querySelectorAll('#tabla-body tr:not(.empty-row)');
            let visibles = 0;
            ...
            document.getElementById('conteo').textContent = visibles + ' registros';
        }
    </script>
