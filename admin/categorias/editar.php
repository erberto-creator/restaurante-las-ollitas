...
<head>
    ...
    <title>Editar Categoría - Admin Las Ollitas</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="topbar">
            <p class="topbar-breadcrumb">Admin / Categorías / <span>Editar</span></p>
        ...
        <div class="content">
            ...
            <div class="page-head">
                <h1 class="page-head-title">Editar Categoría</h1>
                <p class="page-head-sub">Modifica el nombre de la categoría seleccionada</p>
            </div>

            <div class="id-badge">
                Editando ID: <strong>#<?php echo $fila['id']; ?></strong>
            </div>

            <div class="form-card">
                <div class="form-card-header">
                    <div class="edit-dot"></div>
                    <span class="form-card-header-title">Modificar datos</span>
                </div>
                <div class="form-card-body">
                    <form method="POST">

                        <label class="form-label-custom">Nombre de la categoría</label>
                        <span class="form-hint">Modifica el nombre y guarda los cambios</span>
                        <input
                            type="text"
                            name="nombre"
