...
<head>
    ...
    <title>Promociones - Admin Las Ollitas</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="topbar">
            <p class="topbar-breadcrumb">Admin / <span>Promociones</span></p>
        ...
        <div class="content">
            ...
            <div class="page-head">
                <div>
                    <h1 class="page-head-title">Promociones</h1>
                    <p class="page-head-sub">Gestiona las ofertas y descuentos del restaurante</p>
                </div>
                <a href="crear.php" class="btn-nueva">+ Nueva Promoción</a>
            </div>

            <div class="tabla-card">
                <div class="tabla-header">
                    <span class="tabla-header-title">Listado de promociones</span>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) {
                            ...
                            // Calcular estado de la promo
                            if ($hoy >= $fila['fecha_inicio'] && $hoy <= $fila['fecha_fin']) {
                                $estadoClase = 'badge-activa';
                                $estadoTexto = '● Activa';
                            } elseif ($hoy < $fila['fecha_inicio']) {
                                $estadoClase = 'badge-proxima';
                                $estadoTexto = '◐ Próxima';
                            } else {
                                $estadoClase = 'badge-vencida';
                                $estadoTexto = '○ Vencida';
                            }
                            ?>
                            <tr>
                                ...
                                <td>
                                    <p class="td-titulo"><?php echo $fila['titulo']; ?></p>
                                    <p class="td-titulo-desc">
                                        <?php echo mb_strimwidth($fila['descripcion'], 0, 50, '...'); ?></p>
                                </td>

                                <td>
                                    <span
                                        class="badge-estado <?php echo $estadoClase; ?>"><?php echo $estadoTexto; ?></span>
                                </td>
                        ...
                        <?php if ($total === 0): ?>
                            <tr class="empty-row">
                                <td colspan="7">🎁 No hay promociones registradas aún.</td>
                            </tr>
                        <?php endif; ?>
